...
def main():
    ...
    # Through the same door as the GUI: this script exists to be pointed at
    # a controller something else may be talking to, so it is the likeliest
    # second opener on the bench.
